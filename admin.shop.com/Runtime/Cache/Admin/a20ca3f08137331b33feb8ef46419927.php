        ...
        <form method="post" action="<?php echo U();?>">
            <table cellspacing="1" cellpadding="3" width="100%">
                ...
                <tr>
                    ...
                    <td>
                        <input type='text' name='price' maxlength='60' value='<?php echo ($price); ?>'/> <span
                            class="require-field">*</span>
                    </td>
                </tr>
                <tr>
                    <td class="label">是否支持送货时间</td>
                    <td>
                        <input type='radio' class='is_time' name='is_time' value='0'/>不支持<input type='radio'
                                                                                                class='is_time'
                                                                                                name='is_time'
                                                                                                value='1'/>支持 <span
                            class="require-field">*</span>
                ...
                <tr>
                    ...
                    <td>
                        <input type='radio' class='is_default' name='is_default' value='1'/>默认
                        <input type='radio' class='is_default' name='is_default' value='0'/>不默认
...
<script>
    ...
    <script type="text/javascript">
        $(function(){
            $('.is_time').val([<?php echo ((isset($is_default) && ($is_default !== ""))?($is_default):0); ?>]);
            $('.is_default').val([<?php echo ((isset($is_default) && ($is_default !== ""))?($is_default):0); ?>]);
        });
    </script>
