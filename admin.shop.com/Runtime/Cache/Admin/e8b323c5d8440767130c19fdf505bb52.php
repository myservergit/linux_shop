...
<input type="button" value="删除" class="ajax_post" href="<?php echo U('changeStatus');?>">
<input type="button" value="显示" class="ajax_post" href="<?php echo U('changeStatus',array('status'=>1));?>">
<input type="button" value="隐藏" class="ajax_post" href="<?php echo U('changeStatus',array('status'=>0));?>">
