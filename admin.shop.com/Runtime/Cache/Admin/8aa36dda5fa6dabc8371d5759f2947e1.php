        ...
        <form method="post" action="<?php echo U();?>">
            <table cellspacing="1" cellpadding="3" width="100%">
                ...
                <tr>
                    ...
                    <td>
                        <input type='radio' class='is_default' name='is_default' <?php if(($is_default) == "1"): ?>checked<?php endif; ?> value='1'/>默认
                        <input type='radio' class='is_default' name='is_default' <?php if(($is_default) == "0"): ?>checked<?php endif; ?> value='0'/>不默认
