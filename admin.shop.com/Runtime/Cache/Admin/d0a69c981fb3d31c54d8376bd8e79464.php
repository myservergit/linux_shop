    ...
    <div class="main-div">
        <form method="post" action="<?php echo U();?>">
            <table cellspacing="1" cellpadding="3" width="100%">
                        ...
                        <td>
                            <input type='text' name='goods_type_id' maxlength='60' value='<?php echo ($goods_type_id); ?>'/>                            <span class="require-field">*</span>
                        </td>
                    </tr>
                                    <tr>
                        <td class="label">属性类型</td>
                        <td>
                            <input type='radio' class='type' name='type' value='0'/>单值<input type='radio' class='type' name='type' value='1'/>多值                            <span class="require-field">*</span>
                        </td>
                    </tr>
                                    <tr>
                        <td class="label">录入方式</td>
                        <td>
                            <input type='radio' class='input_type' name='input_type' value='0'/>手工录入<input type='radio' class='input_type' name='input_type' value='1'/>从下面可选值中选择<input type='radio' class='input_type' name='input_type' value='2'/>多行文本                            <span class="require-field">*</span>
                        </td>
                    </tr>
                                    <tr>
                        <td class="label">可选值</td>
                        <td>
                            <input type='text' name='option_values' maxlength='60' value='<?php echo ($option_values); ?>'/>                            <span class="require-field">*</span>
                        </td>
                    </tr>
                                    <tr>
                        <td class="label">排序</td>
                        <td>
                            <input type="text" name="sort" maxlength="40" size="15" value="<?php echo ((isset($sort) && ($sort !== ""))?($sort):20); ?>"/>                            <span class="require-field">*</span>
                        </td>
                    </tr>
                                    <tr>
